 ...
 */
@ThreadSafe
public class AdlUnderFileSystem extends BaseUnderFileSystem
  ...
  public AdlUnderFileSystem(AlluxioURI ufsUri, UnderFileSystemConfiguration conf,
    ...
    try {
      ...
      mFileSystem = new AdlFileSystem();
      mFileSystem.initialize(new URI(ufsUri.toString()), hdfsConf);
